...
#ifndef NET_MINECRAFT_UTIL_MATH_DIRECTION$AXIS$2_HPP
#define NET_MINECRAFT_UTIL_MATH_DIRECTION$AXIS$2_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.util.math.Direction$Axis$2
 * Remapped: ji$a$2
 */
namespace Direction$Axis$2 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ji$a$2", "net/minecraft/core/Direction$Axis$2", "net/minecraft/class_2350$class_2351$2", "net/minecraft/util/math/Direction$Axis$2", "net/minecraft/src/C_4687_$C_4689_$C_4691_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_UTIL_MATH_DIRECTION$AXIS$2_HPP