...
#ifndef NET_MINECRAFT_UTIL_MATH_AXISCYCLEDIRECTION$2_HPP
#define NET_MINECRAFT_UTIL_MATH_AXISCYCLEDIRECTION$2_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.util.math.AxisCycleDirection$2
 * Remapped: ja$2
 */
namespace AxisCycleDirection$2 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ja$2", "net/minecraft/core/AxisCycle$2", "net/minecraft/class_2335$2", "net/minecraft/util/math/AxisCycleDirection$2", "net/minecraft/src/C_4670_$C_4672_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_UTIL_MATH_AXISCYCLEDIRECTION$2_HPP