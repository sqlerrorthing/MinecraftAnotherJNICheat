...
#ifndef NET_MINECRAFT_UTIL_MATH_RANDOM_RANDOMSEQUENCESSTATE$WRAPPEDRANDOM_HPP
#define NET_MINECRAFT_UTIL_MATH_RANDOM_RANDOMSEQUENCESSTATE$WRAPPEDRANDOM_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.util.math.random.RandomSequencesState$WrappedRandom
 * Remapped: bqy$a
 */
namespace RandomSequencesState$WrappedRandom {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("bqy$a", "net/minecraft/world/RandomSequences$DirtyMarkingRandomSource", "net/minecraft/class_8565$class_8629", "net/minecraft/util/math/random/RandomSequencesState$WrappedRandom", "net/minecraft/src/C_286923_$C_290293_"));
        }
        return cachedClass;
    };

    // getter for private field net.minecraft.util.math.random.RandomSequencesState$WrappedRandom#random
    static jobject get_field_random(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("c", "random", "field_44864", "random", "f_290870_"), "Layw;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static private field net.minecraft.util.math.random.RandomSequencesState$WrappedRandom#random
...
#endif // NET_MINECRAFT_UTIL_MATH_RANDOM_RANDOMSEQUENCESSTATE$WRAPPEDRANDOM_HPP