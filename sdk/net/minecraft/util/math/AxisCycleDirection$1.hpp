...
#ifndef NET_MINECRAFT_UTIL_MATH_AXISCYCLEDIRECTION$1_HPP
#define NET_MINECRAFT_UTIL_MATH_AXISCYCLEDIRECTION$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.util.math.AxisCycleDirection$1
 * Remapped: ja$1
 */
namespace AxisCycleDirection$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ja$1", "net/minecraft/core/AxisCycle$1", "net/minecraft/class_2335$1", "net/minecraft/util/math/AxisCycleDirection$1", "net/minecraft/src/C_4670_$C_4671_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_UTIL_MATH_AXISCYCLEDIRECTION$1_HPP