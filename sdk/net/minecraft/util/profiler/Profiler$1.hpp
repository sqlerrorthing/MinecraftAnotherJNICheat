...
#ifndef NET_MINECRAFT_UTIL_PROFILER_PROFILER$1_HPP
#define NET_MINECRAFT_UTIL_PROFILER_PROFILER$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.util.profiler.Profiler$1
 * Remapped: bnf$1
 */
namespace Profiler$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("bnf$1", "net/minecraft/util/profiling/ProfilerFiller$1", "net/minecraft/class_3695$1", "net/minecraft/util/profiler/Profiler$1", "net/minecraft/src/C_442_$C_443_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_UTIL_PROFILER_PROFILER$1_HPP