...
#ifndef NET_MINECRAFT_FLUID_LAVAFLUID$FLOWING_HPP
#define NET_MINECRAFT_FLUID_LAVAFLUID$FLOWING_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.fluid.LavaFluid$Flowing
 * Remapped: eph$a
 */
namespace LavaFluid$Flowing {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("eph$a", "net/minecraft/world/level/material/LavaFluid$Flowing", "net/minecraft/class_3616$class_3617", "net/minecraft/fluid/LavaFluid$Flowing", "net/minecraft/src/C_2693_$C_2694_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_FLUID_LAVAFLUID$FLOWING_HPP