...
#ifndef NET_MINECRAFT_CLIENT_RENDER_MODEL_BUILTINBAKEDMODEL_HPP
#define NET_MINECRAFT_CLIENT_RENDER_MODEL_BUILTINBAKEDMODEL_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.render.model.BuiltinBakedModel
 * Remapped: gsp
 */
namespace BuiltinBakedModel {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("gsp", "net/minecraft/client/resources/model/BuiltInModel", "net/minecraft/class_1090", "net/minecraft/client/render/model/BuiltinBakedModel", "net/minecraft/src/C_4530_"));
        }
        return cachedClass;
    };

    // getter for private field net.minecraft.client.render.model.BuiltinBakedModel#transformation
    static jobject get_field_transformation(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("a", "itemTransforms", "field_5404", "transformation", "f_119167_"), "Lggi;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static private field net.minecraft.client.render.model.BuiltinBakedModel#transformation
    static void set_field_transformation(const jobject &obj, const jobject &value) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("a", "itemTransforms", "field_5404", "transformation", "f_119167_"), "Lggi;");
        return MinecraftSDK::env->SetObjectField(obj, fieldID, value);
    };

    // getter for private field net.minecraft.client.render.model.BuiltinBakedModel#itemPropertyOverrides
    static jobject get_field_itemPropertyOverrides(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("b", "overrides", "field_5405", "itemPropertyOverrides", "f_119168_"), "Lggg;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static private field net.minecraft.client.render.model.BuiltinBakedModel#itemPropertyOverrides
    static void set_field_itemPropertyOverrides(const jobject &obj, const jobject &value) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("b", "overrides", "field_5405", "itemPropertyOverrides", "f_119168_"), "Lggg;");
        return MinecraftSDK::env->SetObjectField(obj, fieldID, value);
    };

    // getter for private field net.minecraft.client.render.model.BuiltinBakedModel#sprite
    static jobject get_field_sprite(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("c", "particleTexture", "field_16594", "sprite", "f_119169_"), "Lgql;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static private field net.minecraft.client.render.model.BuiltinBakedModel#sprite
    static void set_field_sprite(const jobject &obj, const jobject &value) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("c", "particleTexture", "field_16594", "sprite", "f_119169_"), "Lgql;");
        return MinecraftSDK::env->SetObjectField(obj, fieldID, value);
    };

    // getter for private field net.minecraft.client.render.model.BuiltinBakedModel#sideLit
    static jboolean get_field_sideLit(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("d", "usesBlockLight", "field_21862", "sideLit", "f_119170_"), "Z");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetBooleanField(obj, fieldID);
    };

    // setter for static private field net.minecraft.client.render.model.BuiltinBakedModel#sideLit
...
#endif // NET_MINECRAFT_CLIENT_RENDER_MODEL_BUILTINBAKEDMODEL_HPP