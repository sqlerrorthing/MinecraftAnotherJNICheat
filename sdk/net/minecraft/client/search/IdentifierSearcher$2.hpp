...
#ifndef NET_MINECRAFT_CLIENT_SEARCH_IDENTIFIERSEARCHER$2_HPP
#define NET_MINECRAFT_CLIENT_SEARCH_IDENTIFIERSEARCHER$2_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.search.IdentifierSearcher$2
 * Remapped: guj$2
 */
namespace IdentifierSearcher$2 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("guj$2", "net/minecraft/client/searchtree/ResourceLocationSearchTree$2", "net/minecraft/class_7455$2", "net/minecraft/client/search/IdentifierSearcher$2", "net/minecraft/src/C_213444_$C_213446_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_SEARCH_IDENTIFIERSEARCHER$2_HPP