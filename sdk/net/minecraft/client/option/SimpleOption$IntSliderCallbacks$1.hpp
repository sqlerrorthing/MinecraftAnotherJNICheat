...
#ifndef NET_MINECRAFT_CLIENT_OPTION_SIMPLEOPTION$INTSLIDERCALLBACKS$1_HPP
#define NET_MINECRAFT_CLIENT_OPTION_SIMPLEOPTION$INTSLIDERCALLBACKS$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.option.SimpleOption$IntSliderCallbacks$1
 * Remapped: fgr$g$1
 */
namespace SimpleOption$IntSliderCallbacks$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("fgr$g$1", "net/minecraft/client/OptionInstance$IntRangeBase$1", "net/minecraft/class_7172$class_7275$1", "net/minecraft/client/option/SimpleOption$IntSliderCallbacks$1", "net/minecraft/src/C_213334_$C_213342_$C_213343_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_OPTION_SIMPLEOPTION$INTSLIDERCALLBACKS$1_HPP