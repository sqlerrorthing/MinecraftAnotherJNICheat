...
#ifndef NET_MINECRAFT_CLIENT_FONT_UNIHEXFONT$UNICODETEXTUREGLYPH$1_HPP
#define NET_MINECRAFT_CLIENT_FONT_UNIHEXFONT$UNICODETEXTUREGLYPH$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.font.UnihexFont$UnicodeTextureGlyph$1
 * Remapped: fls$d$1
 */
namespace UnihexFont$UnicodeTextureGlyph$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("fls$d$1", "net/minecraft/client/gui/font/providers/UnihexProvider$Glyph$1", "net/minecraft/class_391$class_393$1", "net/minecraft/client/font/UnihexFont$UnicodeTextureGlyph$1", "net/minecraft/src/C_283731_$C_283730_$C_283722_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_FONT_UNIHEXFONT$UNICODETEXTUREGLYPH$1_HPP