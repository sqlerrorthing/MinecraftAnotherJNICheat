...
#ifndef NET_MINECRAFT_CLIENT_FONT_BITMAPFONT$BITMAPFONTGLYPH$1_HPP
#define NET_MINECRAFT_CLIENT_FONT_BITMAPFONT$BITMAPFONTGLYPH$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.font.BitmapFont$BitmapFontGlyph$1
 * Remapped: flm$b$1
 */
namespace BitmapFont$BitmapFontGlyph$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("flm$b$1", "net/minecraft/client/gui/font/providers/BitmapProvider$Glyph$1", "net/minecraft/class_386$class_388$1", "net/minecraft/client/font/BitmapFont$BitmapFontGlyph$1", "net/minecraft/src/C_3522_$C_3525_$C_213379_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_FONT_BITMAPFONT$BITMAPFONTGLYPH$1_HPP