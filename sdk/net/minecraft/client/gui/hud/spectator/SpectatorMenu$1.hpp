...
#ifndef NET_MINECRAFT_CLIENT_GUI_HUD_SPECTATOR_SPECTATORMENU$1_HPP
#define NET_MINECRAFT_CLIENT_GUI_HUD_SPECTATOR_SPECTATORMENU$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.gui.hud.spectator.SpectatorMenu$1
 * Remapped: ftr$1
 */
namespace SpectatorMenu$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ftr$1", "net/minecraft/client/gui/spectator/SpectatorMenu$1", "net/minecraft/class_531$1", "net/minecraft/client/gui/hud/spectator/SpectatorMenu$1", "net/minecraft/src/C_3776_$C_3777_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_GUI_HUD_SPECTATOR_SPECTATORMENU$1_HPP