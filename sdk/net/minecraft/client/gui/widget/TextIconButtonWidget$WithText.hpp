...
#ifndef NET_MINECRAFT_CLIENT_GUI_WIDGET_TEXTICONBUTTONWIDGET$WITHTEXT_HPP
#define NET_MINECRAFT_CLIENT_GUI_WIDGET_TEXTICONBUTTONWIDGET$WITHTEXT_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.gui.widget.TextIconButtonWidget$WithText
 * Remapped: fjr$c
 */
namespace TextIconButtonWidget$WithText {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("fjr$c", "net/minecraft/client/gui/components/SpriteIconButton$TextAndIcon", "net/minecraft/class_8662$class_8665", "net/minecraft/client/gui/widget/TextIconButtonWidget$WithText", "net/minecraft/src/C_290288_$C_290270_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_GUI_WIDGET_TEXTICONBUTTONWIDGET$WITHTEXT_HPP