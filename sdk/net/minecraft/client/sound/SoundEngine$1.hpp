...
#ifndef NET_MINECRAFT_CLIENT_SOUND_SOUNDENGINE$1_HPP
#define NET_MINECRAFT_CLIENT_SOUND_SOUNDENGINE$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.sound.SoundEngine$1
 * Remapped: ezf$1
 */
namespace SoundEngine$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ezf$1", "com/mojang/blaze3d/audio/Library$1", "net/minecraft/class_4225$1", "net/minecraft/client/sound/SoundEngine$1", "net/minecraft/src/C_3085_$C_3086_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_SOUND_SOUNDENGINE$1_HPP