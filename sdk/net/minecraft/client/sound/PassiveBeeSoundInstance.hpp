...
#ifndef NET_MINECRAFT_CLIENT_SOUND_PASSIVEBEESOUNDINSTANCE_HPP
#define NET_MINECRAFT_CLIENT_SOUND_PASSIVEBEESOUNDINSTANCE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.sound.PassiveBeeSoundInstance
 * Remapped: gtm
 */
namespace PassiveBeeSoundInstance {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("gtm", "net/minecraft/client/resources/sounds/BeeFlyingSoundInstance", "net/minecraft/class_4509", "net/minecraft/client/sound/PassiveBeeSoundInstance", "net/minecraft/src/C_4551_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_SOUND_PASSIVEBEESOUNDINSTANCE_HPP