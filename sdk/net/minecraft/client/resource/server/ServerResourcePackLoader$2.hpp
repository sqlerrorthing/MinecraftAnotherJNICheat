...
#ifndef NET_MINECRAFT_CLIENT_RESOURCE_SERVER_SERVERRESOURCEPACKLOADER$2_HPP
#define NET_MINECRAFT_CLIENT_RESOURCE_SERVER_SERVERRESOURCEPACKLOADER$2_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.resource.server.ServerResourcePackLoader$2
 * Remapped: gtc$2
 */
namespace ServerResourcePackLoader$2 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("gtc$2", "net/minecraft/client/resources/server/DownloadedPackSource$2", "net/minecraft/class_1066$2", "net/minecraft/client/resource/server/ServerResourcePackLoader$2", "net/minecraft/src/C_302037_$C_301994_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_RESOURCE_SERVER_SERVERRESOURCEPACKLOADER$2_HPP