...
#ifndef NET_MINECRAFT_CLIENT_RESOURCE_SERVER_SERVERRESOURCEPACKLOADER$7_HPP
#define NET_MINECRAFT_CLIENT_RESOURCE_SERVER_SERVERRESOURCEPACKLOADER$7_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.client.resource.server.ServerResourcePackLoader$7
 * Remapped: gtc$7
 */
namespace ServerResourcePackLoader$7 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("gtc$7", "net/minecraft/client/resources/server/DownloadedPackSource$7", "net/minecraft/class_1066$7", "net/minecraft/client/resource/server/ServerResourcePackLoader$7", "net/minecraft/src/C_302037_$C_302071_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_CLIENT_RESOURCE_SERVER_SERVERRESOURCEPACKLOADER$7_HPP