...
#ifndef NET_MINECRAFT_DATAFIXER_SCHEMA_SCHEMA1466_HPP
#define NET_MINECRAFT_DATAFIXER_SCHEMA_SCHEMA1466_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.datafixer.schema.Schema1466
 * Remapped: biu
 */
namespace Schema1466 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("biu", "net/minecraft/util/datafix/schemas/V1466", "net/minecraft/class_1237", "net/minecraft/datafixer/schema/Schema1466", "net/minecraft/src/C_390_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_DATAFIXER_SCHEMA_SCHEMA1466_HPP