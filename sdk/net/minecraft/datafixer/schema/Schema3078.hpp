...
#ifndef NET_MINECRAFT_DATAFIXER_SCHEMA_SCHEMA3078_HPP
#define NET_MINECRAFT_DATAFIXER_SCHEMA_SCHEMA3078_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.datafixer.schema.Schema3078
 * Remapped: bkc
 */
namespace Schema3078 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("bkc", "net/minecraft/util/datafix/schemas/V3078", "net/minecraft/class_7093", "net/minecraft/datafixer/schema/Schema3078", "net/minecraft/src/C_213001_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_targetEntityItems() {
       ...
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("a", "registerMob", "method_41318", "targetEntityItems", "m_216773_"), "(Lcom/mojang/datafixers/schemas/Schema;Ljava/util/Map;Ljava/lang/String;)V");
    }
...
#endif // NET_MINECRAFT_DATAFIXER_SCHEMA_SCHEMA3078_HPP