...
#ifndef NET_MINECRAFT_SCREEN_PROPERTYDELEGATE_HPP
#define NET_MINECRAFT_SCREEN_PROPERTYDELEGATE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.screen.PropertyDelegate
 * Remapped: cqf
 */
namespace PropertyDelegate {
    static jclass self() {
        ...
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cqf", "net/minecraft/world/inventory/ContainerData", "net/minecraft/class_3913", "net/minecraft/screen/PropertyDelegate", "net/minecraft/src/C_1246_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_SCREEN_PROPERTYDELEGATE_HPP