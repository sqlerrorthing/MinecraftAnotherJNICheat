...
#ifndef NET_MINECRAFT_ENTITY_AI_BRAIN_SENSOR_NEARESTPLAYERSSENSOR_HPP
#define NET_MINECRAFT_ENTITY_AI_BRAIN_SENSOR_NEARESTPLAYERSSENSOR_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.entity.ai.brain.sensor.NearestPlayersSensor
 * Remapped: cdv
 */
namespace NearestPlayersSensor {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cdv", "net/minecraft/world/entity/ai/sensing/PlayerSensor", "net/minecraft/class_4147", "net/minecraft/entity/ai/brain/sensor/NearestPlayersSensor", "net/minecraft/src/C_771_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_ENTITY_AI_BRAIN_SENSOR_NEARESTPLAYERSSENSOR_HPP