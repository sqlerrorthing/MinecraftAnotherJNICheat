...
#ifndef NET_MINECRAFT_ENTITY_MOB_ILLUSIONERENTITY$GIVEINVISIBILITYGOAL_HPP
#define NET_MINECRAFT_ENTITY_MOB_ILLUSIONERENTITY$GIVEINVISIBILITYGOAL_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.entity.mob.IllusionerEntity$GiveInvisibilityGoal
 * Remapped: ckb$b
 */
namespace IllusionerEntity$GiveInvisibilityGoal {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ckb$b", "net/minecraft/world/entity/monster/Illusioner$IllusionerMirrorSpellGoal", "net/minecraft/class_1581$class_1583", "net/minecraft/entity/mob/IllusionerEntity$GiveInvisibilityGoal", "net/minecraft/src/C_1022_$C_1025_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_ENTITY_MOB_ILLUSIONERENTITY$GIVEINVISIBILITYGOAL_HPP