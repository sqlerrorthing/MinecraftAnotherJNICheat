...
#ifndef NET_MINECRAFT_ENTITY_MOB_WARDENENTITY$VIBRATIONCALLBACK_HPP
#define NET_MINECRAFT_ENTITY_MOB_WARDENENTITY$VIBRATIONCALLBACK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.entity.mob.WardenEntity$VibrationCallback
 * Remapped: cmb$a
 */
namespace WardenEntity$VibrationCallback {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cmb$a", "net/minecraft/world/entity/monster/warden/Warden$VibrationUser", "net/minecraft/class_7260$class_8507", "net/minecraft/entity/mob/WardenEntity$VibrationCallback", "net/minecraft/src/C_213061_$C_279517_"));
        }
        return cachedClass;
    };

    // getter for static private field net.minecraft.entity.mob.WardenEntity$VibrationCallback#RANGE
    [[maybe_unused]] static jint get_field_RANGE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("b", "GAME_EVENT_LISTENER_RANGE", "field_44601", "RANGE", "f_279541_"), "I");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticIntField(clazz, fieldID);
    };

    // setter for static private field net.minecraft.entity.mob.WardenEntity$VibrationCallback#RANGE
    ...
    // getter for private field net.minecraft.entity.mob.WardenEntity$VibrationCallback#positionSource
    static jobject get_field_positionSource(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("c", "positionSource", "field_44602", "positionSource", "f_279600_"), "Ldyd;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static private field net.minecraft.entity.mob.WardenEntity$VibrationCallback#positionSource
...
#endif // NET_MINECRAFT_ENTITY_MOB_WARDENENTITY$VIBRATIONCALLBACK_HPP