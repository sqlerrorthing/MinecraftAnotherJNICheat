...
#ifndef NET_MINECRAFT_ENTITY_BOSS_DRAGON_PHASE_ABSTRACTPHASE_HPP
#define NET_MINECRAFT_ENTITY_BOSS_DRAGON_PHASE_ABSTRACTPHASE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.entity.boss.dragon.phase.AbstractPhase
 * Remapped: cic
 */
namespace AbstractPhase {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cic", "net/minecraft/world/entity/boss/enderdragon/phases/AbstractDragonPhaseInstance", "net/minecraft/class_1512", "net/minecraft/entity/boss/dragon/phase/AbstractPhase", "net/minecraft/src/C_946_"));
        }
        return cachedClass;
    };

    // getter for protected field net.minecraft.entity.boss.dragon.phase.AbstractPhase#dragon
    static jobject get_field_dragon(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("a", "dragon", "field_7036", "dragon", "f_31176_"), "Lcia;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static protected field net.minecraft.entity.boss.dragon.phase.AbstractPhase#dragon
...
#endif // NET_MINECRAFT_ENTITY_BOSS_DRAGON_PHASE_ABSTRACTPHASE_HPP