...
#ifndef NET_MINECRAFT_ENTITY_EFFECT_BADOMENSTATUSEFFECT_HPP
#define NET_MINECRAFT_ENTITY_EFFECT_BADOMENSTATUSEFFECT_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.entity.effect.BadOmenStatusEffect
 * Remapped: brs
 */
namespace BadOmenStatusEffect {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("brs", "net/minecraft/world/effect/BadOmenMobEffect", "net/minecraft/class_8631", "net/minecraft/entity/effect/BadOmenStatusEffect", "net/minecraft/src/C_290282_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_ENTITY_EFFECT_BADOMENSTATUSEFFECT_HPP