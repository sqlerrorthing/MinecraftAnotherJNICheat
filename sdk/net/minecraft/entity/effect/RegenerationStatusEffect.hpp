...
#ifndef NET_MINECRAFT_ENTITY_EFFECT_REGENERATIONSTATUSEFFECT_HPP
#define NET_MINECRAFT_ENTITY_EFFECT_REGENERATIONSTATUSEFFECT_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.entity.effect.RegenerationStatusEffect
 * Remapped: bsf
 */
namespace RegenerationStatusEffect {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("bsf", "net/minecraft/world/effect/RegenerationMobEffect", "net/minecraft/class_8636", "net/minecraft/entity/effect/RegenerationStatusEffect", "net/minecraft/src/C_290226_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_ENTITY_EFFECT_REGENERATIONSTATUSEFFECT_HPP