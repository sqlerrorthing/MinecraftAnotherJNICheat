...
#ifndef NET_MINECRAFT_SERVER_NETWORK_SERVERPLAYERENTITY$2_HPP
#define NET_MINECRAFT_SERVER_NETWORK_SERVERPLAYERENTITY$2_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.server.network.ServerPlayerEntity$2
 * Remapped: aqv$2
 */
namespace ServerPlayerEntity$2 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("aqv$2", "net/minecraft/server/level/ServerPlayer$2", "net/minecraft/class_3222$2", "net/minecraft/server/network/ServerPlayerEntity$2", "net/minecraft/src/C_13_$C_140953_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_SERVER_NETWORK_SERVERPLAYERENTITY$2_HPP