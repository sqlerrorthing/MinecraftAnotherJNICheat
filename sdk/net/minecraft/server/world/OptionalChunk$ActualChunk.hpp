...
#ifndef NET_MINECRAFT_SERVER_WORLD_OPTIONALCHUNK$ACTUALCHUNK_HPP
#define NET_MINECRAFT_SERVER_WORLD_OPTIONALCHUNK$ACTUALCHUNK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.server.world.OptionalChunk$ActualChunk
 * Remapped: aqc$b
 */
namespace OptionalChunk$ActualChunk {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("aqc$b", "net/minecraft/server/level/ChunkResult$Success", "net/minecraft/class_9259$class_9261", "net/minecraft/server/world/OptionalChunk$ActualChunk", "net/minecraft/src/C_313292_$C_313682_"));
        }
        return cachedClass;
    };

    // getter for private field net.minecraft.server.world.OptionalChunk$ActualChunk#value
    static jobject get_field_value(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("a", "value", "comp_2368", "value", "f_314875_"), "Ljava/lang/Object;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static private field net.minecraft.server.world.OptionalChunk$ActualChunk#value
    ...
    static jmethodID methodID__value() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("c", "value", "comp_2368", "value", "f_314875_"), "()Ljava/lang/Object;");
    }
...
#endif // NET_MINECRAFT_SERVER_WORLD_OPTIONALCHUNK$ACTUALCHUNK_HPP