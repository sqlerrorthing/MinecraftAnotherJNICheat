...
#ifndef NET_MINECRAFT_RECIPE_SHULKERBOXCOLORINGRECIPE_HPP
#define NET_MINECRAFT_RECIPE_SHULKERBOXCOLORINGRECIPE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.recipe.ShulkerBoxColoringRecipe
 * Remapped: czl
 */
namespace ShulkerBoxColoringRecipe {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("czl", "net/minecraft/world/item/crafting/ShulkerBoxColoring", "net/minecraft/class_1871", "net/minecraft/recipe/ShulkerBoxColoringRecipe", "net/minecraft/src/C_1480_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_matches() {
       ...
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "matches", "method_17734", "matches", "m_5818_"), "(Lcyp;Ldcw;)Z");
    }
    ...
    static jmethodID methodID_craft() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "assemble", "method_17733", "craft", "m_5874_"), "(Lcyp;Ljo$a;)Lcuq;");
    }
...
#endif // NET_MINECRAFT_RECIPE_SHULKERBOXCOLORINGRECIPE_HPP