...
#ifndef NET_MINECRAFT_RECIPE_MAPCLONINGRECIPE_HPP
#define NET_MINECRAFT_RECIPE_MAPCLONINGRECIPE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.recipe.MapCloningRecipe
 * Remapped: cyx
 */
namespace MapCloningRecipe {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cyx", "net/minecraft/world/item/crafting/MapCloningRecipe", "net/minecraft/class_1855", "net/minecraft/recipe/MapCloningRecipe", "net/minecraft/src/C_1467_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_matches() {
       ...
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "matches", "method_17715", "matches", "m_5818_"), "(Lcyp;Ldcw;)Z");
    }
    ...
    static jmethodID methodID_craft() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "assemble", "method_17714", "craft", "m_5874_"), "(Lcyp;Ljo$a;)Lcuq;");
    }
...
#endif // NET_MINECRAFT_RECIPE_MAPCLONINGRECIPE_HPP