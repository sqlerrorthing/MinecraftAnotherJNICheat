...
#ifndef NET_MINECRAFT_RECIPE_ARMORDYERECIPE_HPP
#define NET_MINECRAFT_RECIPE_ARMORDYERECIPE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.recipe.ArmorDyeRecipe
 * Remapped: cyi
 */
namespace ArmorDyeRecipe {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cyi", "net/minecraft/world/item/crafting/ArmorDyeRecipe", "net/minecraft/class_1849", "net/minecraft/recipe/ArmorDyeRecipe", "net/minecraft/src/C_1452_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_matches() {
       ...
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "matches", "method_17701", "matches", "m_5818_"), "(Lcyp;Ldcw;)Z");
    }
    ...
    static jmethodID methodID_craft() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "assemble", "method_17700", "craft", "m_5874_"), "(Lcyp;Ljo$a;)Lcuq;");
    }
...
#endif // NET_MINECRAFT_RECIPE_ARMORDYERECIPE_HPP