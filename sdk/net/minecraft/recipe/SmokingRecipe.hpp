...
#ifndef NET_MINECRAFT_RECIPE_SMOKINGRECIPE_HPP
#define NET_MINECRAFT_RECIPE_SMOKINGRECIPE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.recipe.SmokingRecipe
 * Remapped: czv
 */
namespace SmokingRecipe {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("czv", "net/minecraft/world/item/crafting/SmokingRecipe", "net/minecraft/class_3862", "net/minecraft/recipe/SmokingRecipe", "net/minecraft/src/C_1490_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_RECIPE_SMOKINGRECIPE_HPP