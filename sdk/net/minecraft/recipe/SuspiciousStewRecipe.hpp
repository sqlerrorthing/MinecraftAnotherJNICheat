...
#ifndef NET_MINECRAFT_RECIPE_SUSPICIOUSSTEWRECIPE_HPP
#define NET_MINECRAFT_RECIPE_SUSPICIOUSSTEWRECIPE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.recipe.SuspiciousStewRecipe
 * Remapped: czx
 */
namespace SuspiciousStewRecipe {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("czx", "net/minecraft/world/item/crafting/SuspiciousStewRecipe", "net/minecraft/class_1873", "net/minecraft/recipe/SuspiciousStewRecipe", "net/minecraft/src/C_1492_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_matches() {
       ...
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "matches", "method_17739", "matches", "m_5818_"), "(Lcyp;Ldcw;)Z");
    }
    ...
    static jmethodID methodID_craft() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "assemble", "method_17738", "craft", "m_5874_"), "(Lcyp;Ljo$a;)Lcuq;");
    }
...
#endif // NET_MINECRAFT_RECIPE_SUSPICIOUSSTEWRECIPE_HPP