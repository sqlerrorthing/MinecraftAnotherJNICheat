...
#ifndef NET_MINECRAFT_RECIPE_TIPPEDARROWRECIPE_HPP
#define NET_MINECRAFT_RECIPE_TIPPEDARROWRECIPE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.recipe.TippedArrowRecipe
 * Remapped: czy
 */
namespace TippedArrowRecipe {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("czy", "net/minecraft/world/item/crafting/TippedArrowRecipe", "net/minecraft/class_1876", "net/minecraft/recipe/TippedArrowRecipe", "net/minecraft/src/C_1493_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_matches() {
       ...
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "matches", "method_17741", "matches", "m_5818_"), "(Lcyp;Ldcw;)Z");
    }
    ...
    static jmethodID methodID_craft() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "assemble", "method_17740", "craft", "m_5874_"), "(Lcyp;Ljo$a;)Lcuq;");
    }
...
#endif // NET_MINECRAFT_RECIPE_TIPPEDARROWRECIPE_HPP