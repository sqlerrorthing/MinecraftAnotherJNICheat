...
#ifndef NET_MINECRAFT_RECIPE_CRAFTINGDECORATEDPOTRECIPE_HPP
#define NET_MINECRAFT_RECIPE_CRAFTINGDECORATEDPOTRECIPE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.recipe.CraftingDecoratedPotRecipe
 * Remapped: cys
 */
namespace CraftingDecoratedPotRecipe {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cys", "net/minecraft/world/item/crafting/DecoratedPotRecipe", "net/minecraft/class_8164", "net/minecraft/recipe/CraftingDecoratedPotRecipe", "net/minecraft/src/C_271065_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_matches() {
       ...
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "matches", "method_49186", "matches", "m_5818_"), "(Lcyp;Ldcw;)Z");
    }
    ...
    static jmethodID methodID_craft() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "assemble", "method_49187", "craft", "m_5874_"), "(Lcyp;Ljo$a;)Lcuq;");
    }
...
#endif // NET_MINECRAFT_RECIPE_CRAFTINGDECORATEDPOTRECIPE_HPP