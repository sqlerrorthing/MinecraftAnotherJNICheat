...
#ifndef NET_MINECRAFT_RECIPE_BLASTINGRECIPE_HPP
#define NET_MINECRAFT_RECIPE_BLASTINGRECIPE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.recipe.BlastingRecipe
 * Remapped: cyk
 */
namespace BlastingRecipe {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cyk", "net/minecraft/world/item/crafting/BlastingRecipe", "net/minecraft/class_3859", "net/minecraft/recipe/BlastingRecipe", "net/minecraft/src/C_1454_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_RECIPE_BLASTINGRECIPE_HPP