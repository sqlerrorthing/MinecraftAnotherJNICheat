...
#ifndef NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$12_HPP
#define NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$12_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.network.codec.PacketCodec$12
 * Remapped: yx$12
 */
namespace PacketCodec$12 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("yx$12", "net/minecraft/network/codec/StreamCodec$8", "net/minecraft/class_9139$12", "net/minecraft/network/codec/PacketCodec$12", "net/minecraft/src/C_313866_$C_313651_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$12_HPP