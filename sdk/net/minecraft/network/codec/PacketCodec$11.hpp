...
#ifndef NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$11_HPP
#define NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$11_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.network.codec.PacketCodec$11
 * Remapped: yx$11
 */
namespace PacketCodec$11 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("yx$11", "net/minecraft/network/codec/StreamCodec$7", "net/minecraft/class_9139$11", "net/minecraft/network/codec/PacketCodec$11", "net/minecraft/src/C_313866_$C_313412_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$11_HPP