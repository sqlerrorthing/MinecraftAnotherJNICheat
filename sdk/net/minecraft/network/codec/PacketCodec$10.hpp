...
#ifndef NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$10_HPP
#define NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$10_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.network.codec.PacketCodec$10
 * Remapped: yx$10
 */
namespace PacketCodec$10 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("yx$10", "net/minecraft/network/codec/StreamCodec$6", "net/minecraft/class_9139$10", "net/minecraft/network/codec/PacketCodec$10", "net/minecraft/src/C_313866_$C_313418_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$10_HPP