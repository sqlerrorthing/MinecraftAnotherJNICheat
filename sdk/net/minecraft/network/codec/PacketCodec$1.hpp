...
#ifndef NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$1_HPP
#define NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.network.codec.PacketCodec$1
 * Remapped: yx$1
 */
namespace PacketCodec$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("yx$1", "net/minecraft/network/codec/StreamCodec$1", "net/minecraft/class_9139$1", "net/minecraft/network/codec/PacketCodec$1", "net/minecraft/src/C_313866_$C_313296_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$1_HPP