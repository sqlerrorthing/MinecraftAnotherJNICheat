...
#ifndef NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$7_HPP
#define NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$7_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.network.codec.PacketCodec$7
 * Remapped: yx$7
 */
namespace PacketCodec$7 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("yx$7", "net/minecraft/network/codec/StreamCodec$3", "net/minecraft/class_9139$7", "net/minecraft/network/codec/PacketCodec$7", "net/minecraft/src/C_313866_$C_313284_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$7_HPP