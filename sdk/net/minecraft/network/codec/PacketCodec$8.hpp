...
#ifndef NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$8_HPP
#define NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$8_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.network.codec.PacketCodec$8
 * Remapped: yx$8
 */
namespace PacketCodec$8 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("yx$8", "net/minecraft/network/codec/StreamCodec$4", "net/minecraft/class_9139$8", "net/minecraft/network/codec/PacketCodec$8", "net/minecraft/src/C_313866_$C_313842_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$8_HPP