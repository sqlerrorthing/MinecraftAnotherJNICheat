...
#ifndef NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$2_HPP
#define NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$2_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.network.codec.PacketCodec$2
 * Remapped: yx$2
 */
namespace PacketCodec$2 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("yx$2", "net/minecraft/network/codec/StreamCodec$10", "net/minecraft/class_9139$2", "net/minecraft/network/codec/PacketCodec$2", "net/minecraft/src/C_313866_$C_313647_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_NETWORK_CODEC_PACKETCODEC$2_HPP