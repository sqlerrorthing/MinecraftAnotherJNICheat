...
#ifndef NET_MINECRAFT_NETWORK_PACKET_S2C_PLAY_BOSSBARS2CPACKET$ACTION_HPP
#define NET_MINECRAFT_NETWORK_PACKET_S2C_PLAY_BOSSBARS2CPACKET$ACTION_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.network.packet.s2c.play.BossBarS2CPacket$Action
 * Remapped: ace$c
 */
namespace BossBarS2CPacket$Action {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ace$c", "net/minecraft/network/protocol/game/ClientboundBossEventPacket$Operation", "net/minecraft/class_2629$class_5882", "net/minecraft/network/packet/s2c/play/BossBarS2CPacket$Action", "net/minecraft/src/C_5044_$C_5046_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_NETWORK_PACKET_S2C_PLAY_BOSSBARS2CPACKET$ACTION_HPP