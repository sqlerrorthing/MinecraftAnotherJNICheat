...
#ifndef NET_MINECRAFT_REGISTRY_ENTRY_REGISTRYENTRY_HPP
#define NET_MINECRAFT_REGISTRY_ENTRY_REGISTRYENTRY_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.registry.entry.RegistryEntry
 * Remapped: jm
 */
namespace RegistryEntry {
    static jclass self() {
        ...
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("jm", "net/minecraft/core/Holder", "net/minecraft/class_6880", "net/minecraft/registry/entry/RegistryEntry", "net/minecraft/src/C_203228_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_getIdAsString() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("g", "getRegisteredName", "method_55840", "getIdAsString", "m_323990_"), "()Ljava/lang/String;");
    }

    static jobject getIdAsString(const jobject& obj) {
                
       const auto methodID = methodID_getIdAsString();
       return MinecraftSDK::env->CallObjectMethod(obj, methodID);
    };
    
    static jmethodID methodID_of() {
       const auto clazz = self();
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("a", "direct", "method_40223", "of", "m_205709_"), "(Ljava/lang/Object;)Ljm;");
    }
...
#endif // NET_MINECRAFT_REGISTRY_ENTRY_REGISTRYENTRY_HPP