...
#ifndef NET_MINECRAFT_ITEM_ITEM$TOOLTIPCONTEXT$1_HPP
#define NET_MINECRAFT_ITEM_ITEM$TOOLTIPCONTEXT$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.item.Item$TooltipContext$1
 * Remapped: cul$b$1
 */
namespace Item$TooltipContext$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cul$b$1", "net/minecraft/world/item/Item$TooltipContext$1", "net/minecraft/class_1792$class_9635$1", "net/minecraft/item/Item$TooltipContext$1", "net/minecraft/src/C_1381_$C_313602_$C_313740_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_ITEM_ITEM$TOOLTIPCONTEXT$1_HPP