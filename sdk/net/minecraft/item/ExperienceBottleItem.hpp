...
#ifndef NET_MINECRAFT_ITEM_EXPERIENCEBOTTLEITEM_HPP
#define NET_MINECRAFT_ITEM_EXPERIENCEBOTTLEITEM_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.item.ExperienceBottleItem
 * Remapped: ctt
 */
namespace ExperienceBottleItem {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ctt", "net/minecraft/world/item/ExperienceBottleItem", "net/minecraft/class_1779", "net/minecraft/item/ExperienceBottleItem", "net/minecraft/src/C_1367_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_ITEM_EXPERIENCEBOTTLEITEM_HPP