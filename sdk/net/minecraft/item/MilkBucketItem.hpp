...
#ifndef NET_MINECRAFT_ITEM_MILKBUCKETITEM_HPP
#define NET_MINECRAFT_ITEM_MILKBUCKETITEM_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.item.MilkBucketItem
 * Remapped: cvd
 */
namespace MilkBucketItem {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cvd", "net/minecraft/world/item/MilkBucketItem", "net/minecraft/class_1805", "net/minecraft/item/MilkBucketItem", "net/minecraft/src/C_1399_"));
        }
        return cachedClass;
    };

    // getter for static private field net.minecraft.item.MilkBucketItem#MAX_USE_TIME
    [[maybe_unused]] static jint get_field_MAX_USE_TIME() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "DRINK_DURATION", "field_30911", "MAX_USE_TIME", "f_151133_"), "I");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticIntField(clazz, fieldID);
    };

    // setter for static private field net.minecraft.item.MilkBucketItem#MAX_USE_TIME
...
#endif // NET_MINECRAFT_ITEM_MILKBUCKETITEM_HPP