...
#ifndef NET_MINECRAFT_ITEM_ITEM$TOOLTIPCONTEXT$3_HPP
#define NET_MINECRAFT_ITEM_ITEM$TOOLTIPCONTEXT$3_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.item.Item$TooltipContext$3
 * Remapped: cul$b$3
 */
namespace Item$TooltipContext$3 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("cul$b$3", "net/minecraft/world/item/Item$TooltipContext$3", "net/minecraft/class_1792$class_9635$3", "net/minecraft/item/Item$TooltipContext$3", "net/minecraft/src/C_1381_$C_313602_$C_313434_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_ITEM_ITEM$TOOLTIPCONTEXT$3_HPP