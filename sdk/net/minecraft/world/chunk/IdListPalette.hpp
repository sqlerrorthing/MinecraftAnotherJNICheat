...
#ifndef NET_MINECRAFT_WORLD_CHUNK_IDLISTPALETTE_HPP
#define NET_MINECRAFT_WORLD_CHUNK_IDLISTPALETTE_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.world.chunk.IdListPalette
 * Remapped: dvf
 */
namespace IdListPalette {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dvf", "net/minecraft/world/level/chunk/GlobalPalette", "net/minecraft/class_2816", "net/minecraft/world/chunk/IdListPalette", "net/minecraft/src/C_2134_"));
        }
        return cachedClass;
    };

    // getter for private field net.minecraft.world.chunk.IdListPalette#idList
    static jobject get_field_idList(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("a", "registry", "field_12828", "idList", "f_62639_"), "Ljr;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static private field net.minecraft.world.chunk.IdListPalette#idList
    ...
    static jmethodID methodID_create() {
       ...
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("a", "create", "method_38286", "create", "m_187898_"), "(ILjr;Ldvp;Ljava/util/List;)Ldvo;");
    }
...
#endif // NET_MINECRAFT_WORLD_CHUNK_IDLISTPALETTE_HPP