...
#ifndef NET_MINECRAFT_WORLD_LEVEL_STORAGE_LEVELSUMMARY$RECOVERYWARNING_HPP
#define NET_MINECRAFT_WORLD_LEVEL_STORAGE_LEVELSUMMARY$RECOVERYWARNING_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.world.level.storage.LevelSummary$RecoveryWarning
 * Remapped: erg$b
 */
namespace LevelSummary$RecoveryWarning {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("erg$b", "net/minecraft/world/level/storage/LevelSummary$CorruptedLevelSummary", "net/minecraft/class_34$class_8896", "net/minecraft/world/level/storage/LevelSummary$RecoveryWarning", "net/minecraft/src/C_2789_$C_301976_"));
        }
        return cachedClass;
    };

    // getter for static private field net.minecraft.world.level.storage.LevelSummary$RecoveryWarning#WARNING_TEXT
    [[maybe_unused]] static jobject get_field_WARNING_TEXT() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("b", "INFO", "field_46833", "WARNING_TEXT", "f_303814_"), "Lwz;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static private field net.minecraft.world.level.storage.LevelSummary$RecoveryWarning#WARNING_TEXT
    ...
    // getter for static private field net.minecraft.world.level.storage.LevelSummary$RecoveryWarning#BUTTON_TEXT
    [[maybe_unused]] static jobject get_field_BUTTON_TEXT() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("c", "RECOVER", "field_46834", "BUTTON_TEXT", "f_302348_"), "Lwz;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static private field net.minecraft.world.level.storage.LevelSummary$RecoveryWarning#BUTTON_TEXT
    [[maybe_unused]] static void set_field_BUTTON_TEXT(const jobject &value) {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("c", "RECOVER", "field_46834", "BUTTON_TEXT", "f_302348_"), "Lwz;");
        return MinecraftSDK::env->SetStaticObjectField(clazz, fieldID, value);
    };

    // getter for private field net.minecraft.world.level.storage.LevelSummary$RecoveryWarning#lastPlayed
    static jlong get_field_lastPlayed(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("d", "lastPlayed", "field_46835", "lastPlayed", "f_302803_"), "J");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetLongField(obj, fieldID);
    };

    // setter for static private field net.minecraft.world.level.storage.LevelSummary$RecoveryWarning#lastPlayed
...
#endif // NET_MINECRAFT_WORLD_LEVEL_STORAGE_LEVELSUMMARY$RECOVERYWARNING_HPP