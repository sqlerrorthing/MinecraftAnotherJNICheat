...
#ifndef NET_MINECRAFT_WORLD_BORDER_WORLDBORDERLISTENER_HPP
#define NET_MINECRAFT_WORLD_BORDER_WORLDBORDERLISTENER_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.world.border.WorldBorderListener
 * Remapped: dur
 */
namespace WorldBorderListener {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dur", "net/minecraft/world/level/border/BorderChangeListener", "net/minecraft/class_2780", "net/minecraft/world/border/WorldBorderListener", "net/minecraft/src/C_2107_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_WORLD_BORDER_WORLDBORDERLISTENER_HPP