...
#ifndef NET_MINECRAFT_WORLD_GEN_CHUNK_CHUNKNOISESAMPLER$BLENDOFFSETDENSITYFUNCTION_HPP
#define NET_MINECRAFT_WORLD_GEN_CHUNK_CHUNKNOISESAMPLER$BLENDOFFSETDENSITYFUNCTION_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.world.gen.chunk.ChunkNoiseSampler$BlendOffsetDensityFunction
 * Remapped: dzc$b
 */
namespace ChunkNoiseSampler$BlendOffsetDensityFunction {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dzc$b", "net/minecraft/world/level/levelgen/NoiseChunk$BlendOffset", "net/minecraft/class_6568$class_6947", "net/minecraft/world/gen/chunk/ChunkNoiseSampler$BlendOffsetDensityFunction", "net/minecraft/src/C_182895_$C_207008_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_WORLD_GEN_CHUNK_CHUNKNOISESAMPLER$BLENDOFFSETDENSITYFUNCTION_HPP