...
#ifndef NET_MINECRAFT_WORLD_GEN_FOLIAGE_LARGEOAKFOLIAGEPLACER_HPP
#define NET_MINECRAFT_WORLD_GEN_FOLIAGE_LARGEOAKFOLIAGEPLACER_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.world.gen.foliage.LargeOakFoliagePlacer
 * Remapped: eft
 */
namespace LargeOakFoliagePlacer {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("eft", "net/minecraft/world/level/levelgen/feature/foliageplacers/FancyFoliagePlacer", "net/minecraft/class_5207", "net/minecraft/world/gen/foliage/LargeOakFoliagePlacer", "net/minecraft/src/C_2378_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.world.gen.foliage.LargeOakFoliagePlacer#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("c", "CODEC", "field_24930", "CODEC", "f_68492_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.world.gen.foliage.LargeOakFoliagePlacer#CODEC
...
#endif // NET_MINECRAFT_WORLD_GEN_FOLIAGE_LARGEOAKFOLIAGEPLACER_HPP