...
#ifndef NET_MINECRAFT_WORLD_GEN_FOLIAGE_BLOBFOLIAGEPLACER_HPP
#define NET_MINECRAFT_WORLD_GEN_FOLIAGE_BLOBFOLIAGEPLACER_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.world.gen.foliage.BlobFoliagePlacer
 * Remapped: efp
 */
namespace BlobFoliagePlacer {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("efp", "net/minecraft/world/level/levelgen/feature/foliageplacers/BlobFoliagePlacer", "net/minecraft/class_4646", "net/minecraft/world/gen/foliage/BlobFoliagePlacer", "net/minecraft/src/C_2375_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.world.gen.foliage.BlobFoliagePlacer#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_24927", "CODEC", "f_68392_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.world.gen.foliage.BlobFoliagePlacer#CODEC
    ...
    // getter for protected field net.minecraft.world.gen.foliage.BlobFoliagePlacer#height
    static jint get_field_height(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("b", "height", "field_23752", "height", "f_68393_"), "I");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetIntField(obj, fieldID);
    };

    // setter for static protected field net.minecraft.world.gen.foliage.BlobFoliagePlacer#height
    ...
    static jmethodID methodID_createCodec() {
       const auto clazz = self();
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("a", "blobParts", "method_28838", "createCodec", "m_68413_"), "(Lcom/mojang/serialization/codecs/RecordCodecBuilder$Instance;)Lcom/mojang/datafixers/Products$P3;");
    }
...
#endif // NET_MINECRAFT_WORLD_GEN_FOLIAGE_BLOBFOLIAGEPLACER_HPP