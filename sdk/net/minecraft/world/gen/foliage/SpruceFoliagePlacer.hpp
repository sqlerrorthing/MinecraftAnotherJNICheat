...
#ifndef NET_MINECRAFT_WORLD_GEN_FOLIAGE_SPRUCEFOLIAGEPLACER_HPP
#define NET_MINECRAFT_WORLD_GEN_FOLIAGE_SPRUCEFOLIAGEPLACER_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.world.gen.foliage.SpruceFoliagePlacer
 * Remapped: ega
 */
namespace SpruceFoliagePlacer {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ega", "net/minecraft/world/level/levelgen/feature/foliageplacers/SpruceFoliagePlacer", "net/minecraft/class_4650", "net/minecraft/world/gen/foliage/SpruceFoliagePlacer", "net/minecraft/src/C_2385_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.world.gen.foliage.SpruceFoliagePlacer#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_24936", "CODEC", "f_68713_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.world.gen.foliage.SpruceFoliagePlacer#CODEC
    ...
    // getter for private field net.minecraft.world.gen.foliage.SpruceFoliagePlacer#trunkHeight
    static jobject get_field_trunkHeight(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("b", "trunkHeight", "field_23757", "trunkHeight", "f_68714_"), "Lbpw;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static private field net.minecraft.world.gen.foliage.SpruceFoliagePlacer#trunkHeight
    static void set_field_trunkHeight(const jobject &obj, const jobject &value) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("b", "trunkHeight", "field_23757", "trunkHeight", "f_68714_"), "Lbpw;");
...
#endif // NET_MINECRAFT_WORLD_GEN_FOLIAGE_SPRUCEFOLIAGEPLACER_HPP