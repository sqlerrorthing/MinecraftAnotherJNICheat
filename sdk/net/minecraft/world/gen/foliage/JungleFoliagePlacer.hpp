...
#ifndef NET_MINECRAFT_WORLD_GEN_FOLIAGE_JUNGLEFOLIAGEPLACER_HPP
#define NET_MINECRAFT_WORLD_GEN_FOLIAGE_JUNGLEFOLIAGEPLACER_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.world.gen.foliage.JungleFoliagePlacer
 * Remapped: efw
 */
namespace JungleFoliagePlacer {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("efw", "net/minecraft/world/level/levelgen/feature/foliageplacers/MegaJungleFoliagePlacer", "net/minecraft/class_5209", "net/minecraft/world/gen/foliage/JungleFoliagePlacer", "net/minecraft/src/C_2382_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.world.gen.foliage.JungleFoliagePlacer#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_24933", "CODEC", "f_68608_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.world.gen.foliage.JungleFoliagePlacer#CODEC
    ...
    // getter for protected field net.minecraft.world.gen.foliage.JungleFoliagePlacer#height
    static jint get_field_height(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("b", "height", "field_24166", "height", "f_68609_"), "I");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetIntField(obj, fieldID);
    };

    // setter for static protected field net.minecraft.world.gen.foliage.JungleFoliagePlacer#height
...
#endif // NET_MINECRAFT_WORLD_GEN_FOLIAGE_JUNGLEFOLIAGEPLACER_HPP