...
#ifndef NET_MINECRAFT_WORLD_GEN_FOLIAGE_PINEFOLIAGEPLACER_HPP
#define NET_MINECRAFT_WORLD_GEN_FOLIAGE_PINEFOLIAGEPLACER_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.world.gen.foliage.PineFoliagePlacer
 * Remapped: efy
 */
namespace PineFoliagePlacer {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("efy", "net/minecraft/world/level/levelgen/feature/foliageplacers/PineFoliagePlacer", "net/minecraft/class_4649", "net/minecraft/world/gen/foliage/PineFoliagePlacer", "net/minecraft/src/C_2384_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.world.gen.foliage.PineFoliagePlacer#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_24935", "CODEC", "f_68676_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.world.gen.foliage.PineFoliagePlacer#CODEC
    ...
    // getter for private field net.minecraft.world.gen.foliage.PineFoliagePlacer#height
    static jobject get_field_height(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("b", "height", "field_23755", "height", "f_68677_"), "Lbpw;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetObjectField(obj, fieldID);
    };

    // setter for static private field net.minecraft.world.gen.foliage.PineFoliagePlacer#height
...
#endif // NET_MINECRAFT_WORLD_GEN_FOLIAGE_PINEFOLIAGEPLACER_HPP