...
#ifndef NET_MINECRAFT_COMMAND_ARGUMENT_COMMANDFUNCTIONARGUMENTTYPE$FUNCTIONARGUMENT_HPP
#define NET_MINECRAFT_COMMAND_ARGUMENT_COMMANDFUNCTIONARGUMENTTYPE$FUNCTIONARGUMENT_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.command.argument.CommandFunctionArgumentType$FunctionArgument
 * Remapped: hb$a
 */
namespace CommandFunctionArgumentType$FunctionArgument {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("hb$a", "net/minecraft/commands/arguments/item/FunctionArgument$Result", "net/minecraft/class_2284$class_2285", "net/minecraft/command/argument/CommandFunctionArgumentType$FunctionArgument", "net/minecraft/src/C_4638_$C_4641_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_COMMAND_ARGUMENT_COMMANDFUNCTIONARGUMENTTYPE$FUNCTIONARGUMENT_HPP