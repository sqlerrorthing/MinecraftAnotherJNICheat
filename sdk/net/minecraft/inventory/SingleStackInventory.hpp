...
#ifndef NET_MINECRAFT_INVENTORY_SINGLESTACKINVENTORY_HPP
#define NET_MINECRAFT_INVENTORY_SINGLESTACKINVENTORY_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.inventory.SingleStackInventory
 * Remapped: eyn
 */
namespace SingleStackInventory {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("eyn", "net/minecraft/world/ticks/ContainerSingleItem", "net/minecraft/class_8181", "net/minecraft/inventory/SingleStackInventory", "net/minecraft/src/C_271034_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_emptyStack() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("h", "removeTheItem", "method_54099", "emptyStack", "m_306595_"), "()Lcuq;");
    }

    static jobject emptyStack(const jobject& obj) {
                
       const auto methodID = methodID_emptyStack();
       return MinecraftSDK::env->CallObjectMethod(obj, methodID);
    };
    ...
    static jmethodID methodID__getStack() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "getItem", "method_5438", "getStack", "m_8020_"), "(I)Lcuq;");
    }

    static jobject _getStack(const jobject& obj, const jint& arg0) {
                
       const auto methodID = methodID__getStack();
       return MinecraftSDK::env->CallObjectMethod(obj, methodID, arg0);
    };
    ...
    static void _setStack(const jobject& obj, const jint& arg0, const jobject& arg1) {
...
#endif // NET_MINECRAFT_INVENTORY_SINGLESTACKINVENTORY_HPP