...
#ifndef NET_MINECRAFT_TEXT_STRINGVISITABLE$1_HPP
#define NET_MINECRAFT_TEXT_STRINGVISITABLE$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.text.StringVisitable$1
 * Remapped: xe$1
 */
namespace StringVisitable$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("xe$1", "net/minecraft/network/chat/FormattedText$1", "net/minecraft/class_5348$1", "net/minecraft/text/StringVisitable$1", "net/minecraft/src/C_5000_$C_5001_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_TEXT_STRINGVISITABLE$1_HPP