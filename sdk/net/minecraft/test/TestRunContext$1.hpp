...
#ifndef NET_MINECRAFT_TEST_TESTRUNCONTEXT$1_HPP
#define NET_MINECRAFT_TEST_TESTRUNCONTEXT$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.test.TestRunContext$1
 * Remapped: ta$1
 */
namespace TestRunContext$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ta$1", "net/minecraft/gametest/framework/GameTestRunner$1", "net/minecraft/class_4520$1", "net/minecraft/test/TestRunContext$1", "net/minecraft/src/C_4892_$C_313868_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_onFinished() {
       ...
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "testCompleted", "method_56232", "onFinished", "m_324014_"), "()V");
    }

    static void onFinished(const jobject& obj) {
...
#endif // NET_MINECRAFT_TEST_TESTRUNCONTEXT$1_HPP