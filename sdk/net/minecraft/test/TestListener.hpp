...
#ifndef NET_MINECRAFT_TEST_TESTLISTENER_HPP
#define NET_MINECRAFT_TEST_TESTLISTENER_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.test.TestListener
 * Remapped: sy
 */
namespace TestListener {
    static jclass self() {
        ...
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("sy", "net/minecraft/gametest/framework/GameTestListener", "net/minecraft/class_4518", "net/minecraft/test/TestListener", "net/minecraft/src/C_4890_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_TEST_TESTLISTENER_HPP