...
#ifndef NET_MINECRAFT_TEST_TESTCONTEXT$1_HPP
#define NET_MINECRAFT_TEST_TESTCONTEXT$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.test.TestContext$1
 * Remapped: sw$1
 */
namespace TestContext$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("sw$1", "net/minecraft/gametest/framework/GameTestHelper$1", "net/minecraft/class_4516$1", "net/minecraft/test/TestContext$1", "net/minecraft/src/C_4888_$C_141821_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_TEST_TESTCONTEXT$1_HPP