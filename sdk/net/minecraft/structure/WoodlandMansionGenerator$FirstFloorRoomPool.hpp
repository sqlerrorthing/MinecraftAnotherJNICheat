...
#ifndef NET_MINECRAFT_STRUCTURE_WOODLANDMANSIONGENERATOR$FIRSTFLOORROOMPOOL_HPP
#define NET_MINECRAFT_STRUCTURE_WOODLANDMANSIONGENERATOR$FIRSTFLOORROOMPOOL_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.structure.WoodlandMansionGenerator$FirstFloorRoomPool
 * Remapped: emn$a
 */
namespace WoodlandMansionGenerator$FirstFloorRoomPool {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("emn$a", "net/minecraft/world/level/levelgen/structure/structures/WoodlandMansionPieces$FirstFloorRoomCollection", "net/minecraft/class_3471$class_3472", "net/minecraft/structure/WoodlandMansionGenerator$FirstFloorRoomPool", "net/minecraft/src/C_213293_$C_213294_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_STRUCTURE_WOODLANDMANSIONGENERATOR$FIRSTFLOORROOMPOOL_HPP