...
#ifndef NET_MINECRAFT_STRUCTURE_WOODLANDMANSIONGENERATOR$ROOMPOOL_HPP
#define NET_MINECRAFT_STRUCTURE_WOODLANDMANSIONGENERATOR$ROOMPOOL_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.structure.WoodlandMansionGenerator$RoomPool
 * Remapped: emn$b
 */
namespace WoodlandMansionGenerator$RoomPool {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("emn$b", "net/minecraft/world/level/levelgen/structure/structures/WoodlandMansionPieces$FloorRoomCollection", "net/minecraft/class_3471$class_3473", "net/minecraft/structure/WoodlandMansionGenerator$RoomPool", "net/minecraft/src/C_213293_$C_213295_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_STRUCTURE_WOODLANDMANSIONGENERATOR$ROOMPOOL_HPP