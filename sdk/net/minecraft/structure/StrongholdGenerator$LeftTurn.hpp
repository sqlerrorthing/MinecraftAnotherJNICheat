...
#ifndef NET_MINECRAFT_STRUCTURE_STRONGHOLDGENERATOR$LEFTTURN_HPP
#define NET_MINECRAFT_STRUCTURE_STRONGHOLDGENERATOR$LEFTTURN_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.structure.StrongholdGenerator$LeftTurn
 * Remapped: emj$d
 */
namespace StrongholdGenerator$LeftTurn {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("emj$d", "net/minecraft/world/level/levelgen/structure/structures/StrongholdPieces$LeftTurn", "net/minecraft/class_3421$class_3425", "net/minecraft/structure/StrongholdGenerator$LeftTurn", "net/minecraft/src/C_213268_$C_213275_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_create() {
       const auto clazz = self();
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("a", "createPiece", "method_14859", "create", "m_229575_"), "(Lejw;Layw;IIILji;I)Lemj$d;");
    }
...
#endif // NET_MINECRAFT_STRUCTURE_STRONGHOLDGENERATOR$LEFTTURN_HPP