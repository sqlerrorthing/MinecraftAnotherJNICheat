...
#ifndef NET_MINECRAFT_BLOCK_SPAWNER_ENTITYDETECTOR$SELECTOR$2_HPP
#define NET_MINECRAFT_BLOCK_SPAWNER_ENTITYDETECTOR$SELECTOR$2_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.spawner.EntityDetector$Selector$2
 * Remapped: dse$a$2
 */
namespace EntityDetector$Selector$2 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dse$a$2", "net/minecraft/world/level/block/entity/trialspawner/PlayerDetector$EntitySelector$2", "net/minecraft/class_8962$class_9198$2", "net/minecraft/block/spawner/EntityDetector$Selector$2", "net/minecraft/src/C_302097_$C_313467_$C_313831_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_BLOCK_SPAWNER_ENTITYDETECTOR$SELECTOR$2_HPP