...
#ifndef NET_MINECRAFT_BLOCK_DIRTPATHBLOCK_HPP
#define NET_MINECRAFT_BLOCK_DIRTPATHBLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.DirtPathBlock
 * Remapped: dic
 */
namespace DirtPathBlock {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dic", "net/minecraft/world/level/block/DirtPathBlock", "net/minecraft/class_2369", "net/minecraft/block/DirtPathBlock", "net/minecraft/src/C_141203_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.DirtPathBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_46335", "CODEC", "f_302478_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.DirtPathBlock#CODEC
    ...
    // getter for static protected field net.minecraft.block.DirtPathBlock#SHAPE
    [[maybe_unused]] static jobject get_field_SHAPE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("b", "SHAPE", "field_11106", "SHAPE", "f_153126_"), "Lexv;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static protected field net.minecraft.block.DirtPathBlock#SHAPE
...
#endif // NET_MINECRAFT_BLOCK_DIRTPATHBLOCK_HPP