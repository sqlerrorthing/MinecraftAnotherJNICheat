...
#ifndef NET_MINECRAFT_BLOCK_AZALEABLOCK_HPP
#define NET_MINECRAFT_BLOCK_AZALEABLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.AzaleaBlock
 * Remapped: dfa
 */
namespace AzaleaBlock {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dfa", "net/minecraft/world/level/block/AzaleaBlock", "net/minecraft/class_5800", "net/minecraft/block/AzaleaBlock", "net/minecraft/src/C_141190_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.AzaleaBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_46261", "CODEC", "f_303093_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.AzaleaBlock#CODEC
    ...
    // getter for static private field net.minecraft.block.AzaleaBlock#SHAPE
    [[maybe_unused]] static jobject get_field_SHAPE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("b", "SHAPE", "field_30996", "SHAPE", "f_152064_"), "Lexv;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static private field net.minecraft.block.AzaleaBlock#SHAPE
...
#endif // NET_MINECRAFT_BLOCK_AZALEABLOCK_HPP