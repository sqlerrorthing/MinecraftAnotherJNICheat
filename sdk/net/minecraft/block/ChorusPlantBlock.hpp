...
#ifndef NET_MINECRAFT_BLOCK_CHORUSPLANTBLOCK_HPP
#define NET_MINECRAFT_BLOCK_CHORUSPLANTBLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.ChorusPlantBlock
 * Remapped: dhe
 */
namespace ChorusPlantBlock {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dhe", "net/minecraft/world/level/block/ChorusPlantBlock", "net/minecraft/class_2283", "net/minecraft/block/ChorusPlantBlock", "net/minecraft/src/C_1735_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.ChorusPlantBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_46314", "CODEC", "f_302948_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.ChorusPlantBlock#CODEC
    ...
    static jmethodID methodID_withConnectionProperties() {
       const auto clazz = self();
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("a", "getStateWithConnections", "method_9759", "withConnectionProperties", "m_51710_"), "(Ldcc;Ljd;Ldtc;)Ldtc;");
    }

    static jobject withConnectionProperties(const jobject& arg0, const jobject& arg1, const jobject& arg2) {
       const auto clazz = self();
       const auto methodID = methodID_withConnectionProperties();
...
#endif // NET_MINECRAFT_BLOCK_CHORUSPLANTBLOCK_HPP