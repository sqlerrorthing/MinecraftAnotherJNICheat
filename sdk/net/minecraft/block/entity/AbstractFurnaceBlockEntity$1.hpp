...
#ifndef NET_MINECRAFT_BLOCK_ENTITY_ABSTRACTFURNACEBLOCKENTITY$1_HPP
#define NET_MINECRAFT_BLOCK_ENTITY_ABSTRACTFURNACEBLOCKENTITY$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.entity.AbstractFurnaceBlockEntity$1
 * Remapped: dpv$1
 */
namespace AbstractFurnaceBlockEntity$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dpv$1", "net/minecraft/world/level/block/entity/AbstractFurnaceBlockEntity$1", "net/minecraft/class_2609$1", "net/minecraft/block/entity/AbstractFurnaceBlockEntity$1", "net/minecraft/src/C_1972_$C_1973_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_BLOCK_ENTITY_ABSTRACTFURNACEBLOCKENTITY$1_HPP