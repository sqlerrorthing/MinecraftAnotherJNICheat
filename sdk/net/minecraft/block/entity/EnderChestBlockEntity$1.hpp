...
#ifndef NET_MINECRAFT_BLOCK_ENTITY_ENDERCHESTBLOCKENTITY$1_HPP
#define NET_MINECRAFT_BLOCK_ENTITY_ENDERCHESTBLOCKENTITY$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.entity.EnderChestBlockEntity$1
 * Remapped: drd$1
 */
namespace EnderChestBlockEntity$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("drd$1", "net/minecraft/world/level/block/entity/EnderChestBlockEntity$1", "net/minecraft/class_2611$1", "net/minecraft/block/entity/EnderChestBlockEntity$1", "net/minecraft/src/C_2007_$C_141249_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_BLOCK_ENTITY_ENDERCHESTBLOCKENTITY$1_HPP