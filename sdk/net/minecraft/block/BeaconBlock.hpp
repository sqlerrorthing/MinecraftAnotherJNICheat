...
#ifndef NET_MINECRAFT_BLOCK_BEACONBLOCK_HPP
#define NET_MINECRAFT_BLOCK_BEACONBLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.BeaconBlock
 * Remapped: dfq
 */
namespace BeaconBlock {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dfq", "net/minecraft/world/level/block/BeaconBlock", "net/minecraft/class_2238", "net/minecraft/block/BeaconBlock", "net/minecraft/src/C_1698_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.BeaconBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_46272", "CODEC", "f_303640_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.BeaconBlock#CODEC
...
#endif // NET_MINECRAFT_BLOCK_BEACONBLOCK_HPP