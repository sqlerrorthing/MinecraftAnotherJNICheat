...
#ifndef NET_MINECRAFT_BLOCK_DEADCORALWALLFANBLOCK_HPP
#define NET_MINECRAFT_BLOCK_DEADCORALWALLFANBLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.DeadCoralWallFanBlock
 * Remapped: dfj
 */
namespace DeadCoralWallFanBlock {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dfj", "net/minecraft/world/level/block/BaseCoralWallFanBlock", "net/minecraft/class_2222", "net/minecraft/block/DeadCoralWallFanBlock", "net/minecraft/src/C_1691_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.DeadCoralWallFanBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("b", "CODEC", "field_46269", "CODEC", "f_302444_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.DeadCoralWallFanBlock#CODEC
    ...
    // getter for static public field net.minecraft.block.DeadCoralWallFanBlock#FACING
    [[maybe_unused]] static jobject get_field_FACING() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("c", "FACING", "field_9933", "FACING", "f_49192_"), "Ldtw;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.DeadCoralWallFanBlock#FACING
    ...
    // getter for static private field net.minecraft.block.DeadCoralWallFanBlock#FACING_TO_SHAPE
    [[maybe_unused]] static jobject get_field_FACING_TO_SHAPE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("e", "SHAPES", "field_9934", "FACING_TO_SHAPE", "f_49193_"), "Ljava/util/Map;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static private field net.minecraft.block.DeadCoralWallFanBlock#FACING_TO_SHAPE
...
#endif // NET_MINECRAFT_BLOCK_DEADCORALWALLFANBLOCK_HPP