...
#ifndef NET_MINECRAFT_BLOCK_NETHERRACKBLOCK_HPP
#define NET_MINECRAFT_BLOCK_NETHERRACKBLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.NetherrackBlock
 * Remapped: dlg
 */
namespace NetherrackBlock {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dlg", "net/minecraft/world/level/block/NetherrackBlock", "net/minecraft/class_4773", "net/minecraft/block/NetherrackBlock", "net/minecraft/src/C_1847_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.NetherrackBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_46404", "CODEC", "f_303557_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.NetherrackBlock#CODEC
...
#endif // NET_MINECRAFT_BLOCK_NETHERRACKBLOCK_HPP