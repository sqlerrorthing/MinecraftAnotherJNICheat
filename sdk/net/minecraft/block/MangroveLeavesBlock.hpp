...
#ifndef NET_MINECRAFT_BLOCK_MANGROVELEAVESBLOCK_HPP
#define NET_MINECRAFT_BLOCK_MANGROVELEAVESBLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.MangroveLeavesBlock
 * Remapped: dks
 */
namespace MangroveLeavesBlock {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dks", "net/minecraft/world/level/block/MangroveLeavesBlock", "net/minecraft/class_7114", "net/minecraft/block/MangroveLeavesBlock", "net/minecraft/src/C_213095_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.MangroveLeavesBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_46394", "CODEC", "f_302498_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.MangroveLeavesBlock#CODEC
...
#endif // NET_MINECRAFT_BLOCK_MANGROVELEAVESBLOCK_HPP