...
#ifndef NET_MINECRAFT_BLOCK_MOSSBLOCK_HPP
#define NET_MINECRAFT_BLOCK_MOSSBLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.MossBlock
 * Remapped: dkw
 */
namespace MossBlock {
    static jclass self() {
        ...
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dkw", "net/minecraft/world/level/block/MossBlock", "net/minecraft/class_5807", "net/minecraft/block/MossBlock", "net/minecraft/src/C_141218_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.MossBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_46397", "CODEC", "f_303334_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.MossBlock#CODEC
...
#endif // NET_MINECRAFT_BLOCK_MOSSBLOCK_HPP