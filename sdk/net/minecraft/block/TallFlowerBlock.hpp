...
#ifndef NET_MINECRAFT_BLOCK_TALLFLOWERBLOCK_HPP
#define NET_MINECRAFT_BLOCK_TALLFLOWERBLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.TallFlowerBlock
 * Remapped: dod
 */
namespace TallFlowerBlock {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dod", "net/minecraft/world/level/block/TallFlowerBlock", "net/minecraft/class_2521", "net/minecraft/block/TallFlowerBlock", "net/minecraft/src/C_1936_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.TallFlowerBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("c", "CODEC", "field_46469", "CODEC", "f_302429_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.TallFlowerBlock#CODEC
...
#endif // NET_MINECRAFT_BLOCK_TALLFLOWERBLOCK_HPP