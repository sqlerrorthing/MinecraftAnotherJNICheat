...
#ifndef NET_MINECRAFT_BLOCK_NYLIUMBLOCK_HPP
#define NET_MINECRAFT_BLOCK_NYLIUMBLOCK_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.block.NyliumBlock
 * Remapped: dli
 */
namespace NyliumBlock {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("dli", "net/minecraft/world/level/block/NyliumBlock", "net/minecraft/class_4849", "net/minecraft/block/NyliumBlock", "net/minecraft/src/C_1849_"));
        }
        return cachedClass;
    };

    // getter for static public field net.minecraft.block.NyliumBlock#CODEC
    [[maybe_unused]] static jobject get_field_CODEC() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "CODEC", "field_46406", "CODEC", "f_302251_"), "Lcom/mojang/serialization/MapCodec;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.block.NyliumBlock#CODEC
    ...
    static jmethodID methodID_stayAlive() {
       const auto clazz = self();
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("b", "canBeNylium", "method_24856", "stayAlive", "m_55078_"), "(Ldtc;Ldcz;Ljd;)Z");
    }

    static jboolean stayAlive(const jobject& arg0, const jobject& arg1, const jobject& arg2) {
       const auto clazz = self();
       const auto methodID = methodID_stayAlive();
    ...
    static jmethodID methodID_generate() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "place", "method_46687", "generate", "m_255258_"), "(Ljz;Lakq;Laqu;Lduz;Layw;Ljd;)V");
    }

    static void generate(const jobject& obj, const jobject& arg0, const jobject& arg1, const jobject& arg2, const jobject& arg3, const jobject& arg4, const jobject& arg5) {
...
#endif // NET_MINECRAFT_BLOCK_NYLIUMBLOCK_HPP