...
#ifndef NET_MINECRAFT_NBT_NBTBYTEARRAY$1_HPP
#define NET_MINECRAFT_NBT_NBTBYTEARRAY$1_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.nbt.NbtByteArray$1
 * Remapped: ty$1
 */
namespace NbtByteArray$1 {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ty$1", "net/minecraft/nbt/ByteArrayTag$1", "net/minecraft/class_2479$1", "net/minecraft/nbt/NbtByteArray$1", "net/minecraft/src/C_4911_$C_4912_"));
        }
        return cachedClass;
    };
    ...
    static jmethodID methodID_read() {
       ...
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("a", "load", "method_23232", "read", "m_7300_"), "(Ljava/io/DataInput;Luk;)Lty;");
    }
    ...
    static jmethodID methodID_readByteArray() {
       const auto clazz = self();
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("d", "readAccounted", "method_53886", "readByteArray", "m_301656_"), "(Ljava/io/DataInput;Luk;)[B");
    }

    static jbyte readByteArray(const jobject& arg0, const jobject& arg1) {
       const auto clazz = self();
...
#endif // NET_MINECRAFT_NBT_NBTBYTEARRAY$1_HPP