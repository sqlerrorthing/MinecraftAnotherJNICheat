...
#ifndef NET_MINECRAFT_NBT_NBTFLOAT_HPP
#define NET_MINECRAFT_NBT_NBTFLOAT_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.nbt.NbtFloat
 * Remapped: ue
 */
namespace NbtFloat {
    static jclass self() {
        ...
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ue", "net/minecraft/nbt/FloatTag", "net/minecraft/class_2494", "net/minecraft/nbt/NbtFloat", "net/minecraft/src/C_4923_"));
        }
        return cachedClass;
    };

    // getter for static private field net.minecraft.nbt.NbtFloat#SIZE
    [[maybe_unused]] static jint get_field_SIZE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("c", "SELF_SIZE_IN_BYTES", "field_41722", "SIZE", "f_263444_"), "I");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticIntField(clazz, fieldID);
    };

    // setter for static private field net.minecraft.nbt.NbtFloat#SIZE
    ...
    // getter for static public field net.minecraft.nbt.NbtFloat#ZERO
    [[maybe_unused]] static jobject get_field_ZERO() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "ZERO", "field_21034", "ZERO", "f_128559_"), "Lue;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.nbt.NbtFloat#ZERO
    ...
    // getter for static public field net.minecraft.nbt.NbtFloat#TYPE
    [[maybe_unused]] static jobject get_field_TYPE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("b", "TYPE", "field_21035", "TYPE", "f_128560_"), "Lva;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.nbt.NbtFloat#TYPE
    ...
    // getter for private field net.minecraft.nbt.NbtFloat#value
    static jfloat get_field_value(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("w", "data", "field_11523", "value", "f_128561_"), "F");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetFloatField(obj, fieldID);
    };

    // setter for static private field net.minecraft.nbt.NbtFloat#value
    ...
    static jmethodID methodID_of() {
       const auto clazz = self();
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("a", "valueOf", "method_23244", "of", "m_128566_"), "(F)Lue;");
    }
    ...
    static jmethodID methodID_copy() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("e", "copy", "method_10587", "copy", "m_6426_"), "()Lue;");
    }
...
#endif // NET_MINECRAFT_NBT_NBTFLOAT_HPP