...
#ifndef NET_MINECRAFT_NBT_SCANNER_NBTSCANNER_HPP
#define NET_MINECRAFT_NBT_SCANNER_NBTSCANNER_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.nbt.scanner.NbtScanner
 * Remapped: uv
 */
namespace NbtScanner {
    static jclass self() {
        static jclass cachedClass = nullptr;
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("uv", "net/minecraft/nbt/StreamTagVisitor", "net/minecraft/class_6836", "net/minecraft/nbt/scanner/NbtScanner", "net/minecraft/src/C_196121_"));
        }
        return cachedClass;
    };
...
#endif // NET_MINECRAFT_NBT_SCANNER_NBTSCANNER_HPP