...
#ifndef NET_MINECRAFT_NBT_NBTLONG_HPP
#define NET_MINECRAFT_NBT_NBTLONG_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.nbt.NbtLong
 * Remapped: uj
 */
namespace NbtLong {
    static jclass self() {
        ...
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("uj", "net/minecraft/nbt/LongTag", "net/minecraft/class_2503", "net/minecraft/nbt/NbtLong", "net/minecraft/src/C_4934_"));
        }
        return cachedClass;
    };

    // getter for static private field net.minecraft.nbt.NbtLong#SIZE
    [[maybe_unused]] static jint get_field_SIZE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("b", "SELF_SIZE_IN_BYTES", "field_41727", "SIZE", "f_263435_"), "I");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticIntField(clazz, fieldID);
    };

    // setter for static private field net.minecraft.nbt.NbtLong#SIZE
    ...
    // getter for static public field net.minecraft.nbt.NbtLong#TYPE
    [[maybe_unused]] static jobject get_field_TYPE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "TYPE", "field_21041", "TYPE", "f_128873_"), "Lva;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.nbt.NbtLong#TYPE
    ...
    // getter for private field net.minecraft.nbt.NbtLong#value
    static jlong get_field_value(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("c", "data", "field_11553", "value", "f_128874_"), "J");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetLongField(obj, fieldID);
    };

    // setter for static private field net.minecraft.nbt.NbtLong#value
    ...
    static jmethodID methodID_of() {
       const auto clazz = self();
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("a", "valueOf", "method_23251", "of", "m_128882_"), "(J)Luj;");
    }
    ...
    static jmethodID methodID_copy() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("e", "copy", "method_10621", "copy", "m_6426_"), "()Luj;");
    }
...
#endif // NET_MINECRAFT_NBT_NBTLONG_HPP