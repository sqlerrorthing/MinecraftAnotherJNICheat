...
#ifndef NET_MINECRAFT_NBT_NBTINT_HPP
#define NET_MINECRAFT_NBT_NBTINT_HPP
#include <sdk.hpp>


/*
 * Minecraft class
 * Original: net.minecraft.nbt.NbtInt
 * Remapped: ug
 */
namespace NbtInt {
    static jclass self() {
        ...
        if (cachedClass == nullptr) {
            cachedClass = MinecraftSDK::env->FindClass(MinecraftSDK::getRemapped("ug", "net/minecraft/nbt/IntTag", "net/minecraft/class_2497", "net/minecraft/nbt/NbtInt", "net/minecraft/src/C_4927_"));
        }
        return cachedClass;
    };

    // getter for static private field net.minecraft.nbt.NbtInt#SIZE
    [[maybe_unused]] static jint get_field_SIZE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("b", "SELF_SIZE_IN_BYTES", "field_41724", "SIZE", "f_263440_"), "I");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticIntField(clazz, fieldID);
    };

    // setter for static private field net.minecraft.nbt.NbtInt#SIZE
    ...
    // getter for static public field net.minecraft.nbt.NbtInt#TYPE
    [[maybe_unused]] static jobject get_field_TYPE() {
        const auto clazz = self();
        const auto fieldID = MinecraftSDK::env->GetStaticFieldID(clazz, MinecraftSDK::getRemapped("a", "TYPE", "field_21037", "TYPE", "f_128670_"), "Lva;");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetStaticObjectField(clazz, fieldID);
    };

    // setter for static public field net.minecraft.nbt.NbtInt#TYPE
    ...
    // getter for private field net.minecraft.nbt.NbtInt#value
    static jint get_field_value(const jobject &obj) {
        const auto fieldID = MinecraftSDK::env->GetFieldID(self(), MinecraftSDK::getRemapped("c", "data", "field_11525", "value", "f_128671_"), "I");
        if(fieldID == nullptr) { return 0; }
        
        return MinecraftSDK::env->GetIntField(obj, fieldID);
    };

    // setter for static private field net.minecraft.nbt.NbtInt#value
    ...
    static jmethodID methodID_of() {
       const auto clazz = self();
       return MinecraftSDK::env->GetStaticMethodID(clazz, MinecraftSDK::getRemapped("a", "valueOf", "method_23247", "of", "m_128679_"), "(I)Lug;");
    }
    ...
    static jmethodID methodID_copy() {
       const auto clazz = self();
       return MinecraftSDK::env->GetMethodID(clazz, MinecraftSDK::getRemapped("e", "copy", "method_10592", "copy", "m_6426_"), "()Lug;");
    }
...
#endif // NET_MINECRAFT_NBT_NBTINT_HPP